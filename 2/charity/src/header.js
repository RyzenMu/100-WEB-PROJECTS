...
function SocialMedia() {
  const [contactClickMobile, setContactClickMobile] = useState(true);
    ...
    <div className="social-media">
      <div>
        ...
        <div className="header-group">
          ...
          <div>
            {contactClickMobile ? (
              <button onClick={() => setContactClickMobile((prev) => !prev)}>
                Contact us
              </button>
            ) : (
              <div
                className="header-social-media-mobile"
                onClick={() => setContactClickMobile((prev) => !prev)}
              >
                <p>email:</p>
                <p>phone no</p>
              </div>
          ...
          <div>
            {burger ? (
              ...
              <>
                <div
                  className="header-social-media-right-mobile"
